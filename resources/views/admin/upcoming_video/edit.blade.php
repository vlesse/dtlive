...
@section('title', 'Edit Upcoming Video')
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('upcomingvideo') }}">{{__('Label.Video')}}</a>
                    </li>
            ...
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('upcomingvideo') }}" class="btn btn-default mw-120" style="margin-top:-14px">{{__('Label.Video List')}}</a>
            </div>
        </div>
                        ...
                        <div class="form-group col-lg-6 trailer_box">
                            <div style="display: block;">
                                ...
                                <div id="container5" style="position: relative;">
                                    ...
                                    <label class="text-gray">@if($result->trailer_type == 'server_file'){{{$result->trailer_url}}}@endif</label>
                                </div>
                            </div>
                        </div>
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'save_edit_video', '{{ route("upcomingvideo") }}');
                    },
