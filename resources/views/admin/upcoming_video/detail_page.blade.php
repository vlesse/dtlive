    ...
    <div class="border-bottom row mb-3">
        <div class="col-sm-10">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('upcomingvideo') }}">Video</a></li>
                <li class="breadcrumb-item active" aria-current="page">Details</li>
            </ol>
        </div>
        <div class="col-sm-2 d-flex align-items-center justify-content-end">
            <a href="{{ route('upcomingvideo') }}" class="btn btn-default mw-150" style="margin-top: -14px;">Video List</a>
        </div>
    </div>
