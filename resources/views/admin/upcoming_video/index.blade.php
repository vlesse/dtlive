    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Upcoming Videos</li>
                </ol>
            </div>
        </div>

        <!-- Search -->
        <form class="" action="{{ route('upcomingvideo')}}" method="GET">
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-4 col-xl-3">
                <a href="{{ route('upcomingvideoAdd') }}" class="add-video-btn">
                    ...
                    <div class="card-body">
                        ...
                        <div class="dropdown dropright">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="{{ route('upcomingvideoDetail', ['id' => $value->id])}}">
                                    <img src="{{ asset('assets/imgs/eye.png') }}" class="dot-icon" />
                                    {{__('Label.Details')}}
                                </a>
                                <a class="dropdown-item" href="{{ route('upcomingvideoEdit', ['id' => $value->id])}}">
                                    <img src="{{ asset('assets/imgs/edit.png') }}" class="dot-icon" />
                                    {{__('Label.Edit')}}
                                </a>
                                <a class="dropdown-item" href="{{ route('upcomingvideoDelete', ['id' => $value->id])}}" onclick="return confirm('Are you sure !!! You want to Delete this Video ?')">
