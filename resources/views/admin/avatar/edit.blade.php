    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            ...
            <div class="col-sm-2 d-flex align-items-center justify-content-end">
                <a href="{{ route('Avatar') }}" class="btn btn-default mw-120" style="margin-top:-14px">Avatar</a>
            </div>
        </div>

        <div class="card custom-border-card mt-3">
            <form enctype="multipart/form-data" id="save_edit_avatar" autocomplete="off" >
                @csrf
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        <div class="form-group">
                            <label>{{__('Label.NAME')}}</label>
                            <input name="name" type="text" class="form-control" id="name" value="{{$result->name}}" placeholder="{{__('Label.Please Enter Category')}}">
                        </div>
                    </div>
                </div>
                <div class="form-row">
