    ...
    <div class="body-content">
        ...
        <div class="border-bottom row mb-3">
            <div class="col-sm-10">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('Label.TV Show')}}</li>
                </ol>
            </div>
        ...
        <div class="page-search mb-3">
            <div class="input-group">
                ...
                <input type="text" id="input_search" class="form-control" placeholder="Search TV Show" aria-label="Search" aria-describedby="basic-addon1">
            </div>
