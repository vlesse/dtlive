...
@section('content')
    <div class="body-content">
        ...
        <div class="card custom-border-card mt-3">
            <form enctype="multipart/form-data" id="save_edit_language" autocomplete="off">
                @csrf
                <div class="form-row">
                    <div class="col-md-6">
                ...
                <div class="border-top mt-2 pt-3 text-right">
                    ...
                    <button type="button" class="btn btn-default mw-120" onclick="save_edit_language()">{{__('Label.UPDATE')}}</button>
                </div>
            </form>
        </div>
    </div>
